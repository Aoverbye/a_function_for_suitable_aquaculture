...
Based on those not-polished at all preliminary plots, I feel confident that that method will work so now I will make a function that just plots suitable depths and SSTs. Adding a species name into the title of the plot isn't super difficult, so I will just throw that in there too. Then I will input suitable depth and SST for oysters, just for testing.
...
2.  Add up all the ones in those regions
